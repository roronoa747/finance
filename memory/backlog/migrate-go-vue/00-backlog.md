...
> **Статус:** 🔄 в работе: Блоки 1 и 2 закрыты 🏁. Блок 3 проверен критиком (shadcn-vue + Overview.vue 1-в-1 с эталоном).
> Следующий шаг: `/accept migrate-go-vue 3`.
...
| **3. Экраны: База** ✅ *(M: фронтенд экраны)* | MGV-08 Экраны `Access.vue` (вход/инвайт) и `Setup.vue` (мастер) | `block-3-screens-base/MGV-08-access-setup.md` | MGV-07 | ✅ |
