...
> **Статус:** Блоки 1–5 🏁 (у Блока 1 деплой перенесён в Блок 6 решением владельца 2026-09-24; CI бэкенда зелёный на `mgv-ci`). Блок 6 «Прод-инфраструктура и cutover» 🔄 — MGV-15…19 ✅ (исполнитель 2026-09-24; репетиция на preview пройдена, `CUTOVER.md` готов); критик ✅ 2026-09-24 (гонки синка Vue, fail-fast функции, защита `testdb`).
> Следующий шаг: `/accept migrate-go-vue 6 ultracode` (промпты — `block-6-prod-cutover/SESSION.md`).
