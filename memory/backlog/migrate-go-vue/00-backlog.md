...
> **Статус:** 🔄 в работе: Блок 1 принят, ревью backend завершено ✅, переход к клинапу `/cleanup migrate-go-vue 1` (L-режим).
> Создан Go-модуль, схема PostgreSQL, авторизация, синхронизация и сквозные E2E тесты.
...
|---|---|---|---|---|
| **1. Go Backend** ✅ принят *(L: безопасность, БД)* | MGV-01 Скелет Go-сервера, конфиг и подключение к PostgreSQL | `block-1-backend/MGV-01-go-skeleton-db.md` | — | ✅ |
