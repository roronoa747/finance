...
| **6. Прод-инфраструктура и cutover** ⬜ *(решение владельца 2026-09-24; задачи строит `/brief` → `/backlog`)* | Деплой Go + Vue одним выходом, fail-fast прода, перенос данных из Supabase, смоук, план отката | — | Блоки 1–5 | ⬜ |
